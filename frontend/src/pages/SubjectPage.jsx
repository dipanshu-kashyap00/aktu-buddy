...
import { getSubjectByCode } from '../services/subjectAPI';
...
const SubjectPage = () => {
  ...
  useEffect(() => {
    const fetchSubject = async () => {
      try {
        const response = await getSubjectByCode(subjectCode);
    ...
    <div className="min-h-screen bg-gray-50 py-12">
      <div className="container mx-auto px-4">
        ...
        <div className="bg-white rounded-lg shadow-md p-6 mb-8">
          ...
          <p className="text-gray-600">Code: <span className="font-medium">{subject.code}</span></p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="bg-white rounded-lg shadow-md p-6">
            ...
            {subject.pyqs && subject.pyqs.length > 0 ? (
              ...
              <p className="text-gray-500 text-center py-8">PYQs coming soon</p>
            )}
          </div>
