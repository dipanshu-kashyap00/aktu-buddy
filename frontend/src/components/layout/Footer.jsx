  ...
  <footer className='bg-blue-900 text-white mt-auto'>
    <div className='max-w-6xl mx-auto px-4 py-8 md:py-10'>
      ...
      <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8'>
        ...
        <div>
          <h3 className='text-base font-bold mb-3'>📚 AKTU Buddy</h3>
          <p className='text-sm text-blue-200 leading-relaxed'>
            Your friendly guide to AKTU success. Notes, PYQs and Quantum — all free.
          </p>
          <p className='text-sm text-blue-300 mt-3'>Owner: Dipanshu Kashyap</p>
      ...
      <div className='border-t border-blue-800 mt-8 pt-6 text-center text-xs text-blue-300 space-y-1'>
        <p>© 2026 AKTU Buddy. All rights reserved.</p>
        <p>Not affiliated with AKTU. For educational purposes only.</p>
      </div>
    </div>
  </footer>
);
